...
public class Test {
	...
	public static void main(String[] args) {
		 Properties properties = new Properties();
	       properties.put(PropertyKeyConst.ProducerId, "PID_zichan100");
	       properties.put(PropertyKeyConst.AccessKey, "LTAI0G8S5R1eLe0T");
	       properties.put(PropertyKeyConst.SecretKey, "liU4grOQz8esB4wNN6oixeL5JmeIZq");
